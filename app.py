...
if menuPrincipal == 'Información':
    ...
    st.markdown('**Comparación de IPs - JUNOS**')
    ...
    st.markdown('**MOP Gestión N2 - Generico**')
    st.markdown('**MOP Proveedor - Generico**')
    st.markdown('**MOP Preaprobadas**')
